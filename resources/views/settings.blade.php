...
<head>
    ...
    <title>BugStream - Account Settings</title>
                    ...
                    <div class="bg-surface-container-lowest rounded-xl custom-shadow border border-outline-variant/40 p-6 flex flex-col justify-between">
                        <div>
                            ...
                            <form action="{{ route('settings.profile.update') }}" method="POST" class="space-y-4">
                                ...
                                <div class="pt-4">
                                    <button type="submit" class="px-5 py-2.5 bg-primary text-on-primary rounded-button font-label-md text-label-md shadow-sm hover:scale-[0.98] transition-transform cursor-pointer">
                                        Update Profile
                                    </button>
                                </div>
                            </form>
